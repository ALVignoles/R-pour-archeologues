---
title: "Séance 3 : Sous-ensembles et visualisation sous tidyverse"
...
plot <- ggplot(data=iris,            # d'abord spécifier le jeu de données 
  ...
  theme_classic()                    # on peut aussi préciser un thème,
                                     # et toutes sortes d'autres choses...

plot   # on a fait un objet graphique, on peut le projetter en tapant son nom
```
...
FELICITATIONS ! Vous avez fait votre premier plot sur ggplot !!
