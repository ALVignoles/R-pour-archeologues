...
Un argument est un objet que l'on passera à la fonction pour qu'elle s'éxecute. De façon générale, les arguments sont rentrés dans l'ordre chronologique dans lequel ils sont programmés dans la fonction. Voyons voir cela de plus près. 
```{r plothelp, echo=T}
?plot
```
