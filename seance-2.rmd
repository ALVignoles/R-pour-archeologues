...
subset(jdd, as.numeric(longueur_cm) < 2) #force un changement de classe de la colonne
# ou
jdd$longueur_cm <- as.numeric(jdd$longueur_cm) # change la classe de la colonne en amont
#puis:
