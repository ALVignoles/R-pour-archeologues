...
subset(jdd, as.numeric(longueur_cm) < 2) #toutes les lignes qui des valeurs de longueur_cm inférieures à 2
...
#jdd[jdd$longueur_cm < 2]  # toutes les lignes qui contiennent "burin" dans la colonne "type"
