...
subset(jdd, as.numeric(longueur_cm) < 2) #forcer un changement de classe de la colonne

jdd$longueur_cm <- as.numeric(jdd$longueur_cm) # ou changer la classe de la colonne en amont
subset(jdd, as.numeric(longueur_cm) < 2)
```
...
#toutes les lignes qui contiennent des valeurs de longueur_cm inférieures à 2
jdd$longueur_cm <- as.numeric(jdd$longueur_cm) #changer la classe de la colonne en amont
