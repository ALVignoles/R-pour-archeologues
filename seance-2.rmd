...
Il existe des fonctions très utiles dans le language R de base (bibliothèque **data.table**), que l'on peut également passer avec les fonctions de la bibliothèque **tydiverse**.\
...
jdd[3,4] #sélectionner la cellule en 3e ligne, 4e colonne
jdd[jdd$type == "burin", ]  #sélectionner toutes les lignes qui contiennent "burin" dans la colonne "type"
```
