...
# R et RStudio
-> Installer les logiciels ou utiliser la version en ligne de R Studio à partir d'Huma-num
...
Pour utiliser la version R Studio d'Huma-num il vous faut:\
1. Contacter assistance@huma-num.fr pour demander l'accès à https://r-tools.huma-num.fr/ \
2. Leur communiquer les éléments suivants:\
Nom, Prénom\
...
Affection d’une instance de GPU : oui/non (si oui par défaut 28SM/28 streamings processus, 10Go Ram)\
