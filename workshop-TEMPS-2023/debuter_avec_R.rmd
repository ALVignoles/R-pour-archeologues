...
install.packages("bookdown") # notez les guillemets avec la fonction install.packages()
```
...
library(knitr)
library(rmarkdown)
library(bookdown) # notez l'absence de guillemet avec la fonction library()
```
