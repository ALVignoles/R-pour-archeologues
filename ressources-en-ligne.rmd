---
title: "Les ressources fr en ligne"
...
- [le blog d'Allison Horst](https://posit.co/blog/artist-in-residence/)  
...
- Pour s'aider à utiliser les principaux packages, il existe des fiches aide-mémoire (cheatsheets) mises en lignes sur le [site officiel de Rstudio/Posit](https://rstudio.com/resources/cheatsheets/).  
- Les packages R sont rencensés sur [https://rdocumentation.org/](https://rdocumentation.org/).  
- Une fiche aide-mémoire [pour l'usage des couleurs en codage hexadécimal](https://www.nceas.ucsb.edu/sites/default/files/2020-04/colorPaletteCheatsheet.pdf) sur R.  
- Une page dédiée à la [création de figures avec R base](https://nicercode.github.io/guides/plotting/).  
...
A voir notamment son livre en ligne [Archaeological Science with R](https://benmarwick.github.io/aswr/)
<!--
[ce powerpoint](https:/rdocumentation.org/benmarwick.github.io/tidyverse-for-archaeology/tidyverse-for-archaeology.html#1) par B Marwick et le repository associé dans [ctv-archaeology](https:/rdocumentation.org/github.com/benmarwick/ctv-archaeology#making-maps-and-using-r-as-a-geographical-information-system). 
-->
Le CRAN Task view archéologie constitute une documentation ouverte concernant l'usage de R en archéologie a été mise en ligne [accessible ici](https://github.com/benmarwick/ctv-archaeology).  
...
- [ce powerpoint](https:/hal.science/hal-03287121/file/plutniak2021rconference.pdf) par Sébastien Plutniak (CNRS).   
...
* [cet ouvrage](https://r-archeo.huma-num.fr/) rédigé par Nicolas Frerebeau (CNRS) et Ben Marwick (U Washington) - en cours de rédaction.  
* [Introduction à R et au tidyverse](https:/juba.github.io/tidyverse/) par @juba
* [Logiciel R et programmation](https:/egallic.fr/Enseignement/R/m1_stat_eco_logiciel_R.pdf) par @3wen
* [Programmer en R](https:/fr.wikibooks.org/wiki/Programmer_en_R), wikibook collaboratif (licence CC-BY-SA)
* [Introduction à l'analyse d'enquêtes avec R et RStudio](https:/larmarange.github.io/analyse-R/) par @larmarange
...
* Le [pôle bioinformatique lyonnais](https:/pbil.univ-lyon1.fr/R/) propose depuis longtemps une somme très importante de documents, qui comprend des cours complets de statistiques utilisant R.
...
* [Manuel d’analyse spatiale : Théorie et mise en oeuvre pratique avec R](https:/insee.fr/fr/information/3635442), Insee Méthodes n° 131 - octobre 2018 par [@inseefr](https:/github.com/inseefr)
* [Se former au logiciel R : initiation et perfectionnement](https:/myrbookfr.netlify.com/), François Rebaudo, 2019-02-13.
* [Le grimoire statistique : Contes et stats R](https:/perso.ens-lyon.fr/lise.vaudor/grimoireStat/_book/intro.html) par @lvaudor
* [UtilitR](https:/utilitr.org/) manuel de R par les agents de l'Insee
...
* [Contes et stats R](https:/perso.ens-lyon.fr/lise.vaudor/grimoireStat/_book/intro.html#pourquoi-ce-livre) par Lise Vaudor

# Banques de données spatiales 
Voici quelques banques de données spatialisées pour vous aider à créer de jolies cartes ou utiliser des données environnementales diverses. 

## Modèles Numériques de Terrain 
* [Liste de MNT en open-source](https://opendem.info/link_dem.html)
* [MNT bathymétrique mondial du NOAA](https://data.noaa.gov/onestop/collections?q=%22digital%20elevation%22)

## Données climatiques et paléoclimatiques 
* [Variables climatiques sub-actuelles du Climatic Research Unit](https://www.uea.ac.uk/groups-and-centres/climatic-research-unit)
* [Variables climatiques actuelles du modèle WorldClim](https://worldclim.org)
* [Variables climatiques actuelles et passées du laboratoire Chelsa](https://chelsa-climate.org)
* [Simulations du climat du BRIDGE](https://www.paleo.bristol.ac.uk/ummodel/list_of_simulations.html)
* [Simulations du climat passé de l'équipe PaleoClim](http://www.paleoclim.org)

## Données hydrographiques
* [Modèle HydroSheds (v2)](https://www.hydrosheds.org/hydrosheds-v2)
...
## Exploration en ligne de données spatialisées
* [Géoportail](https://www.geoportail.gouv.fr)
* [Open Land Map](https://openlandmap.org)
