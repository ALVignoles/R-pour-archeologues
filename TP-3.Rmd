...
2.1. En utilisant le fond créé ("plan.modif"), et pour les pièces qui ne sont 
pas des silex de type A, créez à votre tour un plan avec 
"x_cm" en abscisse et "y_cm" en ordonnée,
des points dont la couleur et la forme correspondent respectivement au 
type de silex et au type d'outil.
