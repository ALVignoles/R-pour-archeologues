...
<code>.../R-pour-archeologues/data/Data_exemple.xlsx</code> 2- Dans cette même fenêtre dans la section `import options` il est possible de spécifier le nom du jeu de données qui sera stocké dans R: appelez le "jdd".\
...
Ces quelques fonctions sont utiles pour explorer les données et se rendre compte d'erreurs ? un stade préliminaire.
